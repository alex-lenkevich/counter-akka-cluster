...
libraryDependencies ++= Seq(
  ...
  "com.typesafe.akka" %% "akka-remote" % version.value,
  "com.typesafe.akka" %% "akka-contrib" % version.value,
  "com.typesafe.akka" %% "akka-cluster-tools" % version.value,
  "com.typesafe.akka" %% "akka-multi-node-testkit" % version.value % "test",
